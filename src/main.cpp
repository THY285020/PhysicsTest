...
#pragma endregion
	...
	Shader shader("E:/3DModel/assets/shader/vertexShader.vs", "E:/3DModel/assets/shader/fragmentShader.fs");
	
	GLuint texture0 = loadTexture("E:/3DModel/assets/texture/DiffuseMap.png");
