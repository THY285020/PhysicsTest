...
#pragma endregion
	...
	Shader shader("E:/3DModel/assets/shader/pointVertex.vs", "E:/3DModel/assets/shader/pointFrag.fs");

	//GLuint texture0 = loadCubeTexture(textures_faces);
	...
	glUniform3fv(glGetUniformLocation(shader.ID, "cameraPos"), 1, glm::value_ptr(cameraPos));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(glGetUniformLocation(shader.ID, "ViewProj"), 1, GL_FALSE, glm::value_ptr(viewproj));
